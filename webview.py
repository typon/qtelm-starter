...
from PyQt5.QtCore import Qt, QObject, QFile, QTimer, QUrl, QSize, QEventLoop, \
    pyqtProperty, pyqtSlot, pyqtSignal
from PyQt5.QtGui import QColor
from PyQt5.QtWidgets import QSizePolicy, QWidget, qApp
...
class _WebViewBase:
    def _evalJS(self, code):
        """Evaluate JavaScript code and return the
